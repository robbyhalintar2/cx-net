...
cd /usr/bin
wget https://raw.githubusercontent.com/robbyhalintar2/cx-net/main/limit/bot.zip
unzip bot.zip
mv bot/* /usr/bin
chmod +x /usr/bin/*
rm -rf bot.zip
cd /root
wget https://raw.githubusercontent.com/robbyhalintar2/cx-net/main/limit/regis.zip
unzip regis.zip
rm -rf regis.zip
